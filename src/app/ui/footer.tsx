      ...
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <div className={`flex flex-col items-start gap-2`}>
            {/*<a*/}
            {/*  className="pointer-events-none flex place-items-center gap-2 p-8 text-primary-800 dark:text-primary-200 lg:pointer-events-auto lg:p-0"*/}
            ...
            {/*  hosztolva.*/}
            {/*</a>*/}
            <p className="prose text-balance text-primary-800 dark:text-primary-200">
            ...
            <menu className="mt-8 flex flex-wrap justify-center gap-6 sm:mt-0 sm:flex-nowrap sm:justify-end">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="transition text-primary hover:opacity-75 dark:text-primary-800 dark:text-primary-200"
                >
        ...
        <p className="prose whitespace-nowrap text-balance text-xs text-primary-800 dark:text-primary-200">
