              ...
              <Entry>
                <EntryContent>
                  ...
                  <DataList>
                    <DataListEntry>
                      <dt className="font-medium text-gray-900 dark:text-primary-800 dark:text-primary-200">Helyszín</dt>
                      <dd className="mt-2 text-sm text-gray-500 dark:text-primary-800 dark:text-primary-200/80">CsabaPark Kolbászmúzeum</dd>
                    </DataListEntry>
                    <DataListEntry>
              ...
              <Entry>
                <EntryContent>
                  ...
                  <DataList>
                    <DataListEntry>
                      <dt className="font-medium text-gray-900 dark:text-primary-800 dark:text-primary-200">Helyszín</dt>
                      <dd className="mt-2 text-sm text-gray-500 dark:text-primary-800 dark:text-primary-200/80">CsabaPark Pálinkamúzeum</dd>
                    </DataListEntry>
                    <DataListEntry>
                      <dt className="font-medium text-gray-900 dark:text-primary-800 dark:text-primary-200">Időpont</dt>
                      <dd className="mt-2 text-sm text-gray-500 dark:text-primary-800 dark:text-primary-200/80">
